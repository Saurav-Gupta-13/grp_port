...
export default function RegisterUpdateForm(props) {
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Register, idProp)
        : registerModelProp;
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Register.copyOf(registerRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "RegisterUpdateForm")}
      {...rest}
    >
      <TextField
        label="First name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || registerModelProp)}
